...
const traffic = [
    new Car(road.getLaneCenter(0), -100, 50, 80, "DUMMY", 2),
    new Car(road.getLaneCenter(3), -300, 50, 80, "DUMMY", 2),
    new Car(road.getLaneCenter(0), -300, 50, 80, "DUMMY", 2),
    new Car(road.getLaneCenter(0), -500, 50, 80, "DUMMY", 2),
    new Car(road.getLaneCenter(3), -500, 50, 80, "DUMMY", 2),
    new Car(road.getLaneCenter(0), -700, 50, 80, "DUMMY", 2),
